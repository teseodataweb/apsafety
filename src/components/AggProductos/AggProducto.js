...
const AggProducto = () => {
  ...
  useEffect(() => {
    ...
    ventajasIntervalRef.current = setInterval(() => {
      setVentajasPlaceholder(prev => prev === 'Ventajas (ligero, alta resistencia, etc)' ? 'Texto separado por comas' : 'Ventajas (ligero, alta resistencia, etc)');
    }, 5000);

    // Animación para aplicaciones
    aplicacionesIntervalRef.current = setInterval(() => {
      setAplicacionesPlaceholder(prev => prev === 'Aplicaciones (cara, interiores, etc)' ? 'Texto separado por comas' : 'Aplicaciones (cara, interiores, etc)');
    }, 5000);
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (Array.isArray(formData.sellos)) {
        productData.sellos = formData.sellos.map(file => file instanceof File ? URL.createObjectURL(file) : file);
      }

      if (Array.isArray(formData.imagenesUrl)) {
        productData.imagenesUrl = formData.imagenesUrl.map(file => file instanceof File ? URL.createObjectURL(file) : file);
      }
      ...
      <div className="row g-4">
        <div className="col-lg-6">
          ...
          <div className="form-clt">
            <input type="text" name="titulo" value={formData.titulo} onChange={handleChange} placeholder="Nombre del producto" />
        ...
        <div className="col-lg-6">
          <p>Clasificación:</p>
          <div className="form-clt">
            <select name="clasificacion" value={formData.clasificacion} onChange={handleChange}>
        ...
        <div className="col-lg-6">
          <p>Ventajas:</p>
          <div className="form-clt">
            <input type="text" name="ventajas" value={formData.ventajas} onChange={handleChange} placeholder={ventajasPlaceholder} onFocus={() => clearInterval(ventajasIntervalRef.current)} />
        ...
        <div className="col-lg-6">
          <p>Aplicaciones:</p>
          <div className="form-clt">
            <input type="text" name="aplicaciones" value={formData.aplicaciones} onChange={handleChange} placeholder={aplicacionesPlaceholder} onFocus={() => clearInterval(aplicacionesIntervalRef.current)} />
        ...
        <div className="col-lg-6">
          ...
          <div className="form-clt">
            <input type="file" accept="application/pdf" onChange={(e) => handleFileChange(e, 'fichaTecnicaUrl')} />
        ...
        <div className="col-lg-6">
          ...
          <div className="form-clt">
            <input type="file" accept="image/*" onChange={(e) => handleFileChange(e, 'imagenPrincipalUrl')} />
        ...
        <div className="col-lg-6">
          <p>Sellos:</p>
          <div className="form-clt">
            <input type="file" multiple onChange={(e) => handleFileChange(e, 'sellos')} />
        ...
        <div className="col-lg-6">
          <p>Imágenes:</p>
          <div className="form-clt">
            <input type="file" multiple onChange={(e) => handleFileChange(e, 'imagenesUrl')} />
        ...
        <div className="col-lg-6">
          ...
          <div className="form-clt">
            <input type="datetime-local" name="fechaCreacion" value={new Date(formData.fechaCreacion).toISOString().slice(0, 16)} onChange={handleChange} />
