...
const AggUssers = () => {
  ...
  const [modalTitle, setModalTitle] = useState('');
   ...
   useEffect(() => {
    // Intentar obtener el usuario de location.state primero
    ...
    // Si no está en location.state, intentar obtenerlo de los parámetros de URL
    else {
  ...
  const handleSubmit = async e => {
    ...
    try {
      if (isEditing) {
        ...
        // Si hay una nueva contraseña, actualizarla en Firebase Auth
        if (formData.password) {
          // Nota: Necesitarías implementar la lógica para actualizar la contraseña aquí
          // Esto podría requerir autenticación previa del usuario actual
          console.log("Se intentaría actualizar la contraseña aquí");
        }
