                ...
                <div className="container">
                    <div className="row g-4 justify-content-center">
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                            <div className="contact-info-items info-card-purple text-center">
                                <div className="icon">
                                    <img src={InfIcon2} alt="Teléfono" className="purple-icon" />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                            <div className="contact-info-items info-card-purple text-center">
                                <div className="icon">
                                    <img src={InfIcon3} alt="Correo electrónico" className="purple-icon" />
                                </div>
                                <div className="content">
                        ...
                        <div className="col-lg-10 mx-auto">
                            <div className="about-content">
                                ...
                                <div className="row wow fadeInUp benefits-container" data-wow-delay=".8s">
                                    <div className="col-md-6">
                                        <ul className="benefits-list">
                                            <li className="mb-3"><i className="fas fa-check-circle purple-text me-2"></i> Reducción de accidentes laborales</li>
                                            <li className="mb-3"><i className="fas fa-check-circle purple-text me-2"></i> Cumplimiento con auditorías</li>
                                        </ul>
                                    </div>
                                    <div className="col-md-6">
                                        <ul className="benefits-list">
                                            <li className="mb-3"><i className="fas fa-check-circle purple-text me-2"></i> Mejora continua en seguridad</li>
                                            <li className="mb-3"><i className="fas fa-check-circle purple-text me-2"></i> Ahorro por selección correcta de EPP</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="cta-section text-center mt-5 py-5 wow fadeInUp" data-wow-delay=".9s">
                                    ...
                                    <Link to="/contacto" className="btn btn-primary btn-lg purple-btn">
